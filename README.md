...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Roboto', sans-serif; background-color: #f9f9f9; color: #333; scroll-behavior: smooth; }
        ...
        nav ul li a:hover { color: #ffec99; }
        ...
        .project-card h3 { padding: 15px; font-size: 1.5rem; color: #364fc7; }
        .project-card p { padding: 0 15px 15px 15px; font-size: 1rem; color: #495057; }
        .project-card:hover { transform: translateY(-10px); box-shadow: 0 12px 30px rgba(0,0,0,0.2); }
        ...
        #contact button:hover { background-color: #364fc7; }

        footer { text-align: center; padding: 30px; background-color: #212529; color: #fff; }
...
<body>
    ...
    <section id="about">
        <h2>About Me</h2>
        <!-- ✅ Your GitHub Image Here -->
        <img src="https://github.com/user-attachments/assets/cf754bb9-e4dc-47ee-8ec6-a9b4c0352d80" alt="Profile Image">
